...
public class ChatMessageDto {
  ...
  public record Request(
      ...
      @Schema(description = "메시지 타입", example = "TEXT", defaultValue = "TEXT") MessageType messageType) {}
  ...
  public record Response(
      ...
      @Schema(description = "미디어 URL (이미지/파일)", nullable = true, example = "https://example.com/image.jpg") String mediaUrl,
