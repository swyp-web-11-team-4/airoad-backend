 ...
 * <h3>실시간 메시지 전송</h3>
 *
 * <p>이 서비스는 {@code SimpMessagingTemplate.convertAndSendToUser()}를 사용하여 특정 사용자의 구독 경로로 메시지를 전송합니다.
 *
 * <ul>
 ...
 * </ul>
 *
 * <p><strong>다른 실시간 메시징 타입</strong>: 일정 알림, 일반 알림 등은 {@link com.swygbro.airoad.backend.realtime}
 * 패키지 문서를 참조하세요.
 *
