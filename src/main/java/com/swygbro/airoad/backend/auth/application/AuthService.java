...
public class AuthService implements AuthUseCase {
  ...
  public TokenResponse createTokens(String email) {
    ...
    log.info("[AUTH] 토큰 생성 완료 - 이메일: {}", SensitiveLogMasker.maskEmail(email));
  ...
  public TokenResponse reissue(String refreshToken) {
    ...
    log.info("[AUTH] 토큰 재발급 완료 - 이메일: {}", SensitiveLogMasker.maskEmail(email));
  ...
  public void logout(String accessToken) {
    ...
    log.info("[AUTH] 로그아웃 완료 - 이메일: {}", SensitiveLogMasker.maskEmail(email));
  }
